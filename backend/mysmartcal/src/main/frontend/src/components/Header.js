        ...
        <header>
            <Navbar bg="dark" variant="dark" expand="lg" collapseOnSelect>
                <Container style={{flexDirection: "column"}}>
                    <Row style={{width: "100%"}}>
                        <LinkContainer to="/">
                            <Navbar.Brand><span><i className='fa fa-calendar'> &nbsp;</i></span>My Smart
                                Cal</Navbar.Brand>
                        </LinkContainer>
                            ...
                            <Nav className="ml-auto">
                                ...
                                {userInfo
                                    ...
                                    <>
                                                                ...
                                                                <NavDropdown.Item className="text-wrap" key={index}>{
                                                                    <div>
                                                                        ...
                                                                        <Row>
                                                                            ...
                                                                            <Button className="col-sm-4" variant="danger"
                                                                                    size="sm" onClick={() => {
                                        ...
                                        <NavDropdown title={<span> <i className='fa fa-user'></i></span>}
                                                     id='user-name'>
                                ...
                                {userInfo.id &&
                                    ...
                                    (
                                        <LinkContainer to="/chat">
                                            <Nav.Link
                                                style={{paddingLeft: "10px", paddingRight: "10px"}}>Messages
                                            </Nav.Link>
                                        </LinkContainer>
                                    )}
                                {userInfo.freelancer ?
                                    (
                                        <LinkContainer to="/">
                                            <Nav.Link
                                                style={{paddingLeft: "10px", paddingRight: "10px"}}>Dashboard
                                            </Nav.Link>
                                        </LinkContainer>
                                    )
                                    :
                                    (
                                        <LinkContainer to="/freelancers">
                                            <Nav.Link style={{
                                                paddingLeft: "10px",
                                                paddingRight: "10px"
                                            }}>Freelancers</Nav.Link>
                                        </LinkContainer>
                                    )}

                                <LinkContainer to="/calendar">
                                    <Nav.Link href="/calendar"
                                              style={{paddingLeft: "10px", paddingRight: "10px"}}>Calendar</Nav.Link>
                                </LinkContainer>
                            </Nav>
                        </Row>
                    )}
